	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/pro_signup/img/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: '/pro_signup/img/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
