...
<?php echo $this->Form->create('PanelType');?>
	<fieldset>
 		<legend><?php __('Edit Panel Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PanelType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PanelType.id'))); ?></li>
